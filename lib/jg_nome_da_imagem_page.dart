...
class JogoNomedaImagem extends StatefulWidget {
  const JogoNomedaImagem({super.key});

  @override
  State<JogoNomedaImagem> createState() {
    return JogoNomedaImagemState();
  }
}

class JogoNomedaImagemState extends State<JogoNomedaImagem> {
  @override
