...
class AreaCriativa extends StatefulWidget {
  const AreaCriativa({super.key});

  @override
  State<AreaCriativa> createState() {
    return AreaCriativaState();
  }
}

class AreaCriativaState extends State<AreaCriativa> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Center(
          child:
          // Conteudo da área criativa
          Text(
            'Aqui ficará a area criativa', // Placeholder do jogo
